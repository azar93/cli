      ...
      <section className="pt-32 pb-16 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl max-w-2xl text-gray-300 mb-8">
            Saytınızı axtarış sistemlərində üst sıralara çıxarın.
          </p>
          <Link
            href="/contact"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 gradient-text">Texniki SEO</h3>
                  <p className="text-gray-300 mb-6">Saytın texniki optimallaşdırılması:</p>
                  <ul className="space-y-3">
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Sürət optimallaşdırma</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 gradient-text">Kontent SEO</h3>
                  <p className="text-gray-300 mb-6">Kontentin optimallaşdırılması:</p>
                  <ul className="space-y-3">
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Açar sözlər analizi</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Meta teqlər</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Kontent strategiyası</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 gradient-text">Off-page SEO</h3>
                  <p className="text-gray-300 mb-6">Xarici SEO işləri:</p>
                  <ul className="space-y-3">
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Backlink strategiyası</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Sosial media inteqrasiyası</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
                      <span>Branding</span>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-6">SEO performansı:</p>
                  <ul className="space-y-3">
                    <li className="flex items-center gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9]"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
                title: 'Audit',
                description: 'Saytın cari vəziyyətini analiz edirik',
                icon: (
              ...
              {
                title: 'Strategiya',
                description: 'SEO strategiyası hazırlayırıq',
                icon: (
                  <svg className="w-8 h-8 text-[#7C3AED]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
              ...
              },
              {
                ...
                description: 'Saytı optimallaşdırırıq',
                icon: (
                  <svg className="w-8 h-8 text-[#7C3AED]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
              ...
              {
                title: 'Monitorinq',
                description: 'Nəticələri izləyirik',
                icon: (
                  <svg className="w-8 h-8 text-[#7C3AED]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20 text-center">
                <div className="w-16 h-16 mx-auto rounded-xl bg-[#7C3AED]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500">
                  {tool.icon}
                </div>
                <h3 className="text-xl font-bold mb-2 gradient-text">{tool.name}</h3>
            ...
            {[
              {
                ...
                text: 'SEO xidmətləri sayəsində saytımız Google-da ilk sıralara çıxdı və trafikimiz 3 dəfə artdı.'
              },
              {
                name: 'Ayşə Əliyeva',
                position: 'Marketing Manager, E-commerce',
                image: '/testimonials/ayse.jpg',
                text: 'Professional SEO xidmətləri ilə satışlarımız artdı və müştəri sayımız yüksəldi.'
              },
              {
                name: 'Rəşad Hüseynov',
                position: 'Founder, Startup',
                image: '/testimonials/resad.jpg',
                text: 'SEO strategiyası sayəsində brendimiz daha güclü oldu və rəqabət üstünlüyü qazandıq.'
              }
              ...
              <div key={index} className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-[#7C3AED]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#7C3AED]/20">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold gradient-text">{testimonial.name}</h3>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 gradient-text">
              SEO Xidmətimizdən İstifadə Etmək İstəyirsiniz?
            </h2>
            <p className="text-xl mb-12 max-w-2xl mx-auto text-gray-300">
              Professional SEO xidmətimizlə saytınızı axtarış sistemlərində üst sıralara çıxarın.
            </p>
